...
Again, $W_{\Delta}$ and \widetilde{W}^i_{\Delta} are two i.i.d. $d$-dimensional normal random variable with $\mathbb{E}[W_{\Delta}] = 0$ and $\text{Cov}[ W_{\Delta}, W_{\Delta} ]= \rho_{i,j} \Delta$
