...
Here, $u$ represents the unknown function, and $\frac{\partial u}{\partial t}$ and $\frac{\partial u}{\partial x_1}$​ denote its partial derivatives with respect to time and each spatial variable $x_i$​, respectively.
