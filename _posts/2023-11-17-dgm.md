...
In this blog post I will first explain all the necessarry background information that is necessary to understand to needed concepts. Then I will show the algorithm presented in the paper. Finally, I will have a look on the experimental results that were made by the authors.
