...
Now, we can achieve a variance reduction if $X_i$ and $Y_i$ have $Cov(X_i, Y_i) < 0$. And for that we can use $Y_i = - X_i$. For more information about antithetic sampling I can recommend 
