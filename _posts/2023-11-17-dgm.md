...
$$L_1f(t_n, x_n; \theta_n) = Lf(t_n, x_n; \theta_n) - \frac{1}{2} \sum^d_{i,j = 1} \rho_{i,j} \sigma_i(x) \sigma_j(x) \frac{\partial^2 f}{\partial x_i x_j}(t, x; \theta)$$

such that trivially

$$Lf(t_n, x_n; \theta_n) = L_1f(t_n, x_n; \theta_n) + \frac{1}{2} \sum^d_{i,j = 1} \rho_{i,j} \sigma_i(x) \sigma_j(x) \frac{\partial^2 f}{\partial x_i x_j}(t, x; \theta)$$
