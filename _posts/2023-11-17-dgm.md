...
$$ \frac{1}{2} \sum^d_{i,j = 1} \rho_{i,j} \sigma_i(x) \sigma_j(x) \frac{\partial^2 f}{\partial x_i x_j}(t, x; \theta) = \lim_{\Delta \to 0}\mathbb{E} [\sum^d_{i=1} \frac{\frac{\partial f}{\partial x_i}(t, x + \sigma(x)W_{\Delta}; \theta) - \frac{\partial f}{\partial x_i}(t, x; \theta)}{\Delta} \sigma_i(x) W^i_{\Delta}] $$
