...
Again, $W_{\Delta}$ and \widetilde{W}^i_{\Delta} are two i.i.d. $d$-dimensional normal random variable with $\mathbb{E}[W_{\Delta}] = 0$ and Cov $[(W_{\Delta})_i, (W_{\Delta})_j] = \rho_{i,j}\Delta$.
