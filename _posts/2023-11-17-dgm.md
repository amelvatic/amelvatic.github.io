...
- $G_1(\theta_n, s_n) \coloneqq (\frac{\partial f}{\partial t}(t_n, x_n; \theta_n) + Lf(t_n, x_n; \theta_n) )^{2}$,

- $G_2(\theta_n, s_n) \coloneqq (f(\tau_n, z_n; \theta_n) - g(\tau_n, z_n) )^{2}$

- and $G_3(\theta_n, s_n) \coloneqq (f(0, w_n; \theta_n) - u_0(w_n))^{2}$
